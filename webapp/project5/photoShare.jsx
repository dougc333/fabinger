...
class PhotoShare extends React.Component {
  ...
  //passed to topbar
  set_engage=(checkBox)=>{
    //console.log("getEngage:",checkBox)
    this.setState({engage:checkBox})
  }
  ...
  render() {
    return (
      ...
      <Grid container spacing={8}>
        <Grid item xs={12}>
          <TopBar usrid={this.state.current_userName} photoInfo={this.state.photoInfo} onCheckBox={this.set_engage}/>
        </Grid>
